return {
  ...
  {"nvim-lua/plenary.nvim", lazy = false},
  {
    ...
    keys = {
      ...
      {"<leader>d", function() require("telescope.builtin").diagnostics({}) end, desc = "LSP Diagnostics"},
      ...
      {"<leader>f", function() require("telescope.builtin").live_grep({}) end, desc = "LSP Diagnostics"},
      ...
      {"<leader><Tab>", function() require("telescope.builtin").buffers() end, desc = "Buffers"},
    },
  },
